...
function makeInfraction(_type, _data)
    ...
    TriggerEvent("gd_utils:oneliner", "~r~Anti-Cheat\n~w~" .. infraction.name)
end
...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        if current_tick.pos.x + current_tick.pos.y + current_tick.pos.z == previous_tick.pos.x + previous_tick.pos.y + previous_tick.pos.z and current_tick.inair == true and current_tick.still == true and current_tick.vel == previous_tick.vel and current_tick.ped == previous_tick.ped then
